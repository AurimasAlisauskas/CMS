            ...
            <div class="row">
                <script type="text/javascript">
                    ...
                    function drawChart() {
                        ...
                        ['Data', 'Count'],
                            <?php
                            $element_text = ['All Posts', 'Published Posts', 'Draft Posts', 'All Comments', 'Pending Comments', 'All Users', 'Subscribers', 'Categories'];
                            $element_count = [$posts_count, $post_published_count, $post_draft_count, $comments_count, $comments_unapproved_count, $users_count, $subscribers_count, $categories_count];
